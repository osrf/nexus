...
#ifndef NEXUS_SYSTEM_ORCHESTRATOR__FOR_EACH_TASK__PAIR_HPP
#define NEXUS_SYSTEM_ORCHESTRATOR__FOR_EACH_TASK__PAIR_HPP
 ...
 */
class ForEachTaskPair : public BT::DecoratorNode
{
  /**
 ...
 */
public: ForEachTaskPair(const std::string& name,
