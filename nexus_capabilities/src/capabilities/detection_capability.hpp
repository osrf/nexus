...
#ifndef SRC__CAPABILITIES__DETECTION_CAPABILITY_HPP
#define SRC__CAPABILITIES__DETECTION_CAPABILITY_HPP
...
/**
 * Capability to detect the offsets of items.
 */
class DetectionCapability : public Capability
{
  /**
...
private: std::unordered_map<std::string,
    rclcpp::Client<endpoints::DetectorService::ServiceType>::
    SharedPtr> _clients;
};
