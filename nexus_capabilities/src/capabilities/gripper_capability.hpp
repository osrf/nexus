...
#ifndef NEXUS_CAPABILITIES__CAPABILITIES__GRIPPER_CAPABILITY_HPP
#define NEXUS_CAPABILITIES__CAPABILITIES__GRIPPER_CAPABILITY_HPP
...
/**
 * Capability to manipulate grippers.
 */
class GripperCapability : public Capability
{
  /**
