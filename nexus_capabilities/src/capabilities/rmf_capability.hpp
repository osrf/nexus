...
#ifndef SRC__CAPABILITIES__RMF_CAPABILITY_HPP
#define SRC__CAPABILITIES__RMF_CAPABILITY_HPP
...
/**
 * Capability to interact with RMF.
 */
class RMFCapability : public Capability
{
  /**
...
#endif  // SRC__CAPABILITIES__RMF_CAPABILITY_HPP